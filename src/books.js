const books = [
...

 {
    ...
    Img: './',
    Description: 'Little Miss Bossy is very bossy (hence her name) and she is as rude as Mr Uppity, so she is given a pair of boots which have a mind of their own; they don\'t listen to her, because she is too bossy.',
  },
...

 {
    ...
    title: 'Mr. Uppity',
    Img: './',
    Description: 'Mr. Uppity lives in Bigtown and he is very rich. He is rude to everybody (they call him Miserable old Uppity) until one day he meets a goblin. When he is rude to the goblin, the goblin shrinks Mr. Uppity so he can fit into a hole in a tree, and they enter the tree to meet the King of the Goblins. The goblin agrees to shrink Mr. Uppity if he is rude to somebody. This happens, until Mr. Uppity is nice. In the end, he\'s still rich, but now he\'s very popular. He most frequently uses the words, "Please" and "Thank you." Hargreaves says, "Thank you for reading this story, and if you\'re ever thinking about being rude to somebody, please keep a sharp lookout for goblins.".',
    },
